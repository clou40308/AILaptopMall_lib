...
//        Session session = Session.getInstance(props);
        ...
        try {       
            ...
            message.setSubject("註冊成功，AI筆電商城"); //TODO: 非常好書改成你的網站名稱
            ...
            map.put("title", "AI筆電商城-歡迎光臨");//TODO: 非常好書改成你的網站名稱
            String ipAddress = java.net.InetAddress.getLocalHost().getHostAddress();
            map.put("host", ipAddress);
            map.put("contextPath", "ailaptopmall");//TODO: 改成你的contextPath
            map.put("port", "8080");
            map.put("webSiteName", "AI筆電商城"); //TODO: 非常好書改成你的網站名稱
            //map.put("bolabola", "廢話");
...
//        Session session = Session.getInstance(props);
        ...
        try {       
            ...
            // Set Subject: header field
            message.setSubject("AI筆電商城，購買成功"); //TODO: 非常好書改成你的網站名稱
            ...
            Map<String, Object> map = new HashMap<>();
            map.put("title", "AI筆電商城，購買成功");//TODO: 非常好書改成你的網站名稱
            String ipAddress = java.net.InetAddress.getLocalHost().getHostAddress();
            map.put("host", ipAddress);
            map.put("contextPath", "ailaptopmall");//TODO: 改成你的contextPath
            map.put("port", "8080");
